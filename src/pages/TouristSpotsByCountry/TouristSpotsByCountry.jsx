...
const TouristSpotsByCountry = () => {
  ...
  useEffect(() => {
    fetch(
      `https://turio-server.vercel.app/spots?countryName=${countryName?.countryName}`
    )
      .then((res) => res.json())
      .then((data) => {
        setSpots(data);
  ...
  return (
    <div className="mb-12">
      <div>
        <h1 className="text-center mt-8 text-5xl font-extrabold px-2">
          Tourist Spots By Country
        </h1>
      </div>
