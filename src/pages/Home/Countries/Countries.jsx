            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto px-5 md:px-2 gap-12">
                {
                    countries?.map((country)=> (
                        <Link to={`/touristSpotByCountry/${country?.countryName}`} key={country._id} className="">
                            <div className="relative bg-cover bg-center bg-no-repeat  h-[450px] p-12 rounded-lg hover:scale-110" style={{ backgroundImage: `url(${country?.imageUrl})`, backgroundSize: 'cover', opacity: "500px"}}>
          <div data-aos="fade-down ">
          <div className="text-white text-center p-4  md:p-0">
            
            <h1 className="text-4xl md:text-5xl  font-extrabold md:mb-8 text-green-600 ">{country?.countryName} </h1>
            
            <p className="mb-6 md:mb-12 font-extrabold lg:text-xl w-full   lg:mx-auto">{country?.shortDescription}
            </p>
